...
export default function EditClientForm({
  ...
  useEffect(() => {
    function handleResize() {
      setIsViewportSmall(window.innerWidth < 640); // Adjust the threshold as needed
    }
  ...
  return (
    <>
      {isViewportSmall ? (
<div className="flex-1 overflow-hidden bg-red-50 rounded-xl">
          <form
            className="min-h-fit flex-1 max-w-full flex flex-wrap flex-row p-4 bg-gray-50"
            onSubmit={handleSubmit}
          >
            <div className="md:flex md:flex-col md:flex-col md:flex-wrap md:w-1/2 gap-y-4 px-4 bg-white">
              ...
              <div className="h-fit mt-4 md:mt-0">
                <label
                  htmlFor="email"
                  className="block text-sm font-semibold leading-6 text-gray-900"
                >
              ...
              <fieldset className="h-fit grow flex flex-col mt-4 md:mt-0">
            ...
            <div className="flex h-1/6 w-full items-center justify-end gap-x-6 px-4 py-4">
              <button
                type="button"
        ...
        <div className="flex-1 overflow-hidden bg-red-50 rounded-xl">
          ...
          >
            <div className="md:flex md:flex-col md:flex-col md:flex-wrap md:w-1/2 gap-y-4 px-4 bg-white">
              ...
              <fieldset className="h-fit grow flex flex-col mt-2 md:mt-0">
                <legend className="text-sm font-semibold leading-6 text-gray-900">
                  Reminder Preference
                </legend>
                <p className="mt-1 text-sm leading-6 text-gray-600 whitespace-normal">
