...
export default function Home() {
  return (
    <main className="overscroll-none flex w-screen h-svh md:min-h-screen flex-row items-center md:justify-center p-8 md:p-24 bg-homepage bg-bottom bg-cover">
      <div className="h-fit md:w-3/4 md:h-[50vh] flex flex-col md:flex-row bg-gray-50 rounded-lg drop-shadow-md ">
